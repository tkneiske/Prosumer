...
def Sensitivity():
   ...
   # Horizon = [36] # 6 Stunden
  #  Horizon = [72]    # 12 Stunden
    Horizon = [108]    # 18 Stunden
...
def MPC(Nachbar, PrHoBin, Season, fore_method, InputChoice,TimeSeriesIn,Haushalt, IncentiveLO, IncentiveER, Abregel):
   ...
   # elif Saison == "Sommer":
    ...
    PreisPlotER.to_csv('RESULTS\Result_OffGrid_Fore_PreisProfil_ER_'+INOUT_string+'_10.csv')    
    PreisPlotLO.to_csv('RESULTS\Result_OffGrid_Fore_PreisProfil_LO_'+INOUT_string+'_10.csv')    
...
#==============================================================================
    ...
    # ------- Save to File --------------------------------------
    # -----------------------------------------------------------------
    Result_Grid_End.to_csv('RESULTS\Result_OffGrid_Fore_Grid_'+INOUT_string+'_10.csv')   
    Result_PV_End.to_csv('RESULTS\Result_OffGrid_Fore_PV_'+INOUT_string+'_10.csv')   
    Result_BAT_End.to_csv('RESULTS\Result_OffGrid_Fore_BAT_'+INOUT_string+'_10.csv')    
    Result_CHP_End.to_csv('RESULTS\Result_OffGrid_Fore_CHP_'+INOUT_string+'_10.csv')    
    Result_TES_End.to_csv('RESULTS\Result_OffGrid_Fore_TES_'+INOUT_string+'_10.csv')    
    Result_Heat_End.to_csv('RESULTS\Result_OffGrid_Fore_Heat_'+INOUT_string+'_10.csv')    

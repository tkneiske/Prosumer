...
def MPC(PrHoBin, Season, fore_method, InChoice,TimeSeriesIn, Haushalt, IncentiveER, IncentiveLO, Abregel):
    ...
    #start_date = '1/20/2013'    # with Tagespersistenz do not use the 1.1.
    #end_date = '1/21/2013'
    #date_year = '1/1/2013'
    #PrHoBin = 72  #72;      
...
#        end_date = '4/5/2013'
   ...
   #     end_date = '6/17/2013'
    ...
    if Saison == 'Uebergang' and PrHoBin > 70:
        PrHoBin = 1000000
    ...
    if Saison == 'Sommer' and PrHoBin > 143:
        PrHoBin = 1000000
        INOUT_string = str(144/6.)+'_'+Saison+'_'+fore_method+'_'+InChoice+'_'+TimeSeriesIn+'_'+Haushalt+'_'+ IncentiveLO+'_'+ IncentiveER+'_'+Abregel
  ...
  #-----------------------------------------------
    ...
    print '%         PV, Battery nach KOSTEN + adhoc          %'     
    print '%                                                  %'
    print '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
    ...
    if Haushalt == 'EFH':                      
        ...
        if InChoice == 'Default':                    
         ...
         print 'ERROR - InChoice MFH', InChoice
    ...
    Result_TESFore_End = pd.concat([-LoadPeriodFore['QLoad1']-LoadPeriodFore['QLoad2'], \
    ...
    Result_CHP_End = pd.concat([-LoadPeriodReal['ELoad'], \
                            -LoadPeriodReal['QLoad1']-LoadPeriodReal['QLoad2'],\
                            CHPelEnd, CHPthEnd, CHPscloadEnd,CHPscbattEnd, CHPexpEnd,\
                            CHPonoffEnd,CHPGas,CHP2QLoad ,CHP2TES], axis=1)                      
    Result_CHPFore_End = pd.concat([-LoadPeriodFore['ELoad'], \
                            -LoadPeriodFore['QLoad1']-LoadPeriodReal['QLoad2'],\
                            CHPelEnd, CHPthEnd, CHPscloadEnd,CHPscbattEnd, CHPexpEnd,\
                            CHPonoffEnd,CHPGas,CHP2QLoad ,CHP2TES], axis=1)                      
    #Heat                            
    ...
    Result_Heat_End = pd.concat([-LoadPeriodReal['QLoad1']-LoadPeriodReal['QLoad2'], AuxEnd, AuxGasEnd], axis=1)                                 	
    Result_HeatFore_End = pd.concat([-LoadPeriodFore['QLoad1']-LoadPeriodFore['QLoad2'], AuxEnd, AuxGasEnd], axis=1)                                 	
    ...
    if len(LoadPeriodFore)-PrHoBin < 0:
        ...
        for timestep in range(0, maxx):    
            ...
            #print PrHoBin, timestep, maxx, Saison
            print PrHoBin, timestep, maxx, Saison, fore_method, InChoice, \
...
#==============================================================================
            ...
            ELoadR[timestep], Q1LoadR[timestep], Q2LoadR[timestep], CHP, Auxilary)
   ...
   #         print 'On/Off', Opt_Result['b_CHP_on'][Opt_Result.index[1]]           
           ...
           #          = Opt_Result['P_CHP_th'][Opt_Result.index[0]]               	                                                        
            ...
            Result_CHPFore_End['CHP on_off'][Result_CHP_End.index[timestep]] \
                     = Opt_Result['b_CHP_on'][Opt_Result.index[0]] 
            Result_CHPFore_End['CHP Gas'][Result_CHP_End.index[timestep]] \
                     = Opt_Result['P_CHP_gas'][Opt_Result.index[0]] 
...
#==============================================================================
    ...
    if len(LoadPeriodFore)-PrHoBin < 0:
       ...
       kpi.Calc_KPI_dummy('Real', 144, CompTime,INOUT_string)
    else:  
    ...
    # ------- Save to File --------------------------------------
    # -----------------------------------------------------------------               
    Result_Grid_End.to_csv('RESULTS\Result_Adhoc_Real_Grid_'+INOUT_string+'.csv')   
    Result_PV_End.to_csv('RESULTS\Result_Adhoc_Real_PV_'+INOUT_string+'.csv')   
    Result_BAT_End.to_csv('RESULTS\Result_Adhoc_Real_BAT_'+INOUT_string+'.csv')    
    Result_CHP_End.to_csv('RESULTS\Result_Adhoc_Real_CHP_'+INOUT_string+'.csv')    
    Result_TES_End.to_csv('RESULTS\Result_Adhoc_Real_TES_'+INOUT_string+'.csv')    
    Result_Heat_End.to_csv('RESULTS\Result_Adhoc_Real_Heat_'+INOUT_string+'.csv')    
   
    Result_GridFore_End.to_csv('RESULTS\Result_Adhoc_Fore_Grid_'+INOUT_string+'.csv')   
    Result_PVFore_End.to_csv('RESULTS\Result_Adhoc_Fore_PV_'+INOUT_string+'.csv')   
    Result_BATFore_End.to_csv('RESULTS\Result_Adhoc_Fore_BAT_'+INOUT_string+'.csv')   
    Result_CHPFore_End.to_csv('RESULTS\Result_Adhoc_Fore_CHP_'+INOUT_string+'.csv')   
    Result_TESFore_End.to_csv('RESULTS\Result_Adhoc_Fore_TES_'+INOUT_string+'.csv')   
    Result_HeatFore_End.to_csv('RESULTS\Result_Adhoc_Fore_Heat_'+INOUT_string+'.csv')   

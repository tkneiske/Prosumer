...
#   Grid exchange
           ...
           #     x_axis = np.arange(0,maxxSim)
            ...
            plt.savefig('RESULTS\GridFlowsAdhoc'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
...
#             plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
             plt.savefig('RESULTS\GenerationFlowsAdhoc'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                        orientation='portrait', papertype=None, format=None,
                        transparent=False, bbox_inches='tight', pad_inches=0.1,
                        frameon=None)
             Plotcounter = Plotcounter + 1
...
#                     plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                     plt.savefig('RESULTS\EStorageAdhoc'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                                 orientation='portrait', papertype=None, format=None,
                         transparent=False, bbox_inches='tight', pad_inches=0.1,
                         frameon=None)
                     Plotcounter=Plotcounter+1
...
#                 plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                 plt.savefig('RESULTS\QFlowsAdhoc'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                            orientation='portrait', papertype=None, format=None,
                     transparent=False, bbox_inches='tight', pad_inches=0.1,
                     frameon=None)
                 Plotcounter=Plotcounter+1
             ...
             if NoYes['QStor'] == 1:                           
               #  if max(QStorD) >= 0.005:
                     ...
                     if NoYes['NGBurner'] == 1 and NoYes['CHP'] == 1 and NoYes['EHeatQStor'] == 0:
                         ...
                         fcolors2=[CCHP2QStor, CNGBurner2QStor]
                        ...
                        # plt.plot([], [], color=CCHP2QLoad, linewidth=10, label='Q-CHP-storage-2-load')                                             
                         plt.plot([], [], color=CNGBurner2QStor, linewidth=10, label='NG burner')
                         plt.plot([], [], color=CCHP2QStor, linewidth=10, label='CHP thermal')
                         plt.plot([], [], color=CQStor2QLoad, linewidth=10, label='TES discharge')
                         plt.ylabel('Power [kW]')
...
#                     
#                     plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                     plt.savefig('RESULTS\QStorageAdhoc'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                                 orientation='portrait', papertype=None, format=None,
                         transparent=False, bbox_inches='tight', pad_inches=0.1,
                         frameon=None)
                     Plotcounter=Plotcounter+1

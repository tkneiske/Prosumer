...
def Calc_KPI(Result_BAT_End, Result_PV_End, Result_Grid_End,\
      LoadPeriod, PVavaPeriod, Costs, PrHoBin, maxx, Battery, Delta_t, name):
    ...
    'totalEff', 'BatteryCyc',  'SelfconsumptionPV'])
    print '--------------------------------'     
    print '  Key Performance Indicators [Euro],[kWh]: PredHor: ', PrHoBin*P2E,'h'
    print '--------------------------------'     
    print KPIs                                        
         
    KPIs.to_csv('OUTPUT\KPIs_'+str(name)+'.csv')                                

...
#     eta_batt_sd = 0.03
    ...
    # C_PV_FIT = 0;#17.02.2015 Experiment no FI14.03.2011 22:20T
     ...
     PV_TOT_df.to_csv('OUTPUT\INPUTPV.csv')                        
     LoadAll_TOT_df.to_csv('OUTPUT\INPUTLoad.csv')                        
     Battery.to_csv('OUTPUT\ParameterBattery.csv')                        
     Costs.to_csv('OUTPUT\ParameterCosts.csv')                                        

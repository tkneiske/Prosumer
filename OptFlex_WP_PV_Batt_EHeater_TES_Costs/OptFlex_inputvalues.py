...
def inputvaluesDefault_EFH(Delta_t):          
     # ---------------------------------------------    
...
#     eta_batt_sd = 0.03
   ...
   #  print Auxilary
     ...
     HeatPump = pd.Series([eta_HP, P_HPth_min, P_HPth_max],\
     index=['eta_HP', 'P_HP_th_min', 'P_HP_th_max'])
     print '----------------------------'     
     print '            HeatPump:'
     print '----------------------------'     
     print HeatPump
...
#     return PV_TOT_df, P_PV_max, P_Load_max, LoadAll_TOT_df, Battery,\

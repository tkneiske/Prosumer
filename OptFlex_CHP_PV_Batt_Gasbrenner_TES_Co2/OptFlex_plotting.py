...
#   Grid exchange
           ...
           #     x_axis = np.arange(0,maxxSim)
            ...
            plt.savefig('RESULTS\GridFlows'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
...
#             plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
             plt.savefig('RESULTS\GenerationFlows'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                        orientation='portrait', papertype=None, format=None,
                        transparent=False, bbox_inches='tight', pad_inches=0.1,
                        frameon=None)
             Plotcounter = Plotcounter + 1
...
#                     plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                     plt.savefig('RESULTS\EStorage'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                                 orientation='portrait', papertype=None, format=None,
                         transparent=False, bbox_inches='tight', pad_inches=0.1,
                         frameon=None)
                     Plotcounter=Plotcounter+1
...
#                 plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                 plt.savefig('RESULTS\QFlows'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                            orientation='portrait', papertype=None, format=None,
                     transparent=False, bbox_inches='tight', pad_inches=0.1,
                     frameon=None)
                 Plotcounter=Plotcounter+1
...
#                     
#                     plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                     plt.savefig('RESULTS\QStorage'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                                 orientation='portrait', papertype=None, format=None,
                         transparent=False, bbox_inches='tight', pad_inches=0.1,
                         frameon=None)
                     Plotcounter=Plotcounter+1

...
#                  -sum(Costs['C_PV_FIT']*Result_PV_End['PV Grid export'])*P2E    
    ...
    print '--------------------------------'     
    print KPIs       
    KPIs.to_csv('Results\KPIsAdhocV'+str(name)+'_'+INOUT_string+'_10.csv')                                  
    
    return KPIs
    
    # Dummy if something is wrong
def Calc_KPI_dummy(name, PrHoBin, INOUT_string):
    ...
    'totalCHP2qLoad [kWh]', 'totalCHP2TES [kWh]', 'CompTime [s]', 'totalCO2 [g]', 'totalCO2gas [g]', 'totalCO2grid [g]', 'totalCO2PV [g]'])
    print '--------------------------------'     
    print '  Key Performance Indicators:', PrHoBin
    print '--------------------------------'     
    print KPIs       
    KPIs.to_csv('Results\KPIsAdhocV'+str(name)+'_'+INOUT_string+'_10.csv')   
    print 'Schreibe Results\KPIsAdhocV',str(name),'_',INOUT_string,'_10.csv'
    return KPIs

           ...
           #     x_axis = np.arange(0,maxxSim)
                ...
                if NoYes['GridLoad'] == 1:                 
                     if NoYes['PV'] == 1 and NoYes['CHP'] == 1:
                         ...
                         fcolors=[CCHPGrid, CPVGrid, CGridLoad]
                         plt.stackplot(x_axis,CHPGridWeek,PVGridWeek,-GridLoadWeek,colors=fcolors)  
            ...
            plt.savefig('RESULTS\GridFlowsCost'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
...
#             plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
             plt.savefig('RESULTS\GenerationFlowsCost'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                        orientation='portrait', papertype=None, format=None,
                        transparent=False, bbox_inches='tight', pad_inches=0.1,
                        frameon=None)
             Plotcounter = Plotcounter + 1
...
#------------------------------------------------------------------------
    if SubPlots3 > 0:
             ...
             if NoYes['EStor'] == 1:
                     ...
                     if NoYes['PV'] == 1 and NoYes['CHP'] == 1:
                         #print 'PV, CHP'
                         plt.plot(x_axis, socBat/100.*5.-4., "--", linewidth=1, color='green', label='SOC')                         
...
#                     plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                     plt.savefig('RESULTS\EStorageCost'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                                 orientation='portrait', papertype=None, format=None,
                         transparent=False, bbox_inches='tight', pad_inches=0.1,
                         frameon=None)
                     Plotcounter=Plotcounter+1
...
#                 plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                 plt.savefig('RESULTS\QFlowsCost'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                            orientation='portrait', papertype=None, format=None,
                     transparent=False, bbox_inches='tight', pad_inches=0.1,
                     frameon=None)
                 Plotcounter=Plotcounter+1
...
#                     
#                     plt.xlabel('Day of ''week no. '+str(Week)+' of the year')
                     plt.savefig('RESULTS\QStorageCost'+str(name)+'_'+INOUT_string+'.png', dpi=300, facecolor='w', edgecolor='w',
                                 orientation='portrait', papertype=None, format=None,
                         transparent=False, bbox_inches='tight', pad_inches=0.1,
                         frameon=None)
                     Plotcounter=Plotcounter+1
